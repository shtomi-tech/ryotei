...
window.TRIPS = [
  {
    ...
    costs: [
      { group: "航空券", item: "行き（羽田→函館）", amount: 19590, paid: true, note: "" },
      { group: "航空券", item: "帰り（千歳→羽田）", amount: 21610, paid: true, note: "" },
      { group: "電車", item: "特急 北斗（函館→札幌）", amount: 6830, paid: false, note: "" },
