...
window.TRIPS = [
  {
    ...
    costs: [
      ...
      { group: "食事", item: "旬菜旬魚たじま（夕食）", amount: 3000, paid: false, note: "概算" },
      { group: "食事", item: "漢華林（昼食）", amount: 3000, paid: false, note: "概算" },
      { group: "食事", item: "アザバルバンバン（夕食）", amount: 3000, paid: false, note: "概算" },
      { group: "食事", item: "ホテルのバイキング（朝食）", amount: 0, paid: false, note: "概算" },
